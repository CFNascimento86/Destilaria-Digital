# 📡 Ingestão da camada RAW — ingestao_destilaria.py

O script **ingestao_destilaria.py** é responsável por receber mensagens MQTT do Broker, enviadas pelo CLP Siemens S7‑1200 e gravá‑las na camada RAW do banco de dados.
...
# 🧩 ETL da camada Curated

O script **etl_curated_destilaria.py** é responsável por transformar dados da camada RAW em dados tratados na camada CURATED.  
